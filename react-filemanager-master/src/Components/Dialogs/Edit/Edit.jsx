        ...
        return (
          <div>
            <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-edit" fullWidth={true} maxWidth={'sm'}>
              <DialogTitle id="form-dialog-edit">Редактирование файла </DialogTitle>
              <DialogContent>
                  <DialogContentText>
                    { this.state.loading ? 'Загрузка...' : textArea }
                  </DialogContentText>
              </DialogContent>
              <DialogActions>
                ...
                <Button style={{color: "red"}} onClick={handleSave} type="submit">
                    Обновить
                </Button>
              </DialogActions>
            </Dialog>
